...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order ==0:
		...
		line2=GLine(upper_left_x+length,upper_left_y,upper_left_x+length*0.5,upper_left_y+length*0.866)
		line3=GLine(upper_left_x+length*0.5,upper_left_y+length*0.866,upper_left_x,upper_left_y)
		window.add(line1)
		pause(5)
		window.add(line2)
		pause(5)
